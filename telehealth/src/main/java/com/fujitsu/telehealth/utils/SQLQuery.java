...
public class SQLQuery {
	...
	public static final String SQL_UPDATE_ACCOUNT_SQL = "UPDATE tbl_patient SET th_email=?, th_fname=?, th_middle_name=?, th_lname=?, th_address=?, th_age=?, th_gender=?, th_contact=?, th_password=?, th_condition=? WHERE th_uid=?";
	...
	public static final String SQL_GET_UPLOADED_IMAGE = "SELECT * FROM tbl_appointment WHERE th_uid=?";
